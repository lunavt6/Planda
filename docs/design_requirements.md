...
|1.2|Het product ondersteunt de gebruiker tijdens de activiteit.|[Discovery](discovery.md)|✅|
...
|4.3|De app bevat standaardtaken.|[Develop 1](develop_1.md)|✅|
|4.4|Ouders kunnen eerder ingestelde routines opslaan en opnieuw gebruiken.|[Develop 1](develop_1.md)|✅|
|4.5|De app ondersteunt meerdere kinderaccounts, zodat elk kind een eigen profiel en voortgang heeft.|[Develop 1](develop_1.md)|✅|
|4.6|Beide ouders kunnen via hun eigen smartphone toegang krijgen tot de beer en voortgang bekijken.|[Develop 1](develop_1.md)|✅|
|4.7|Voortgang van kinderen wordt visueel weergegeven.|[Develop 1](develop_1.md)|✅|
|4.8|De app toont voortgang over langere tijd.|[Develop 1](develop_1.md)|✅|
|4.9|Ouders ontvangen herinneringen om oefenmomenten niet te vergeten.|[Develop 1](develop_1.md)|✅|
|4.10|De app geeft praktische tips voor het oefenen van vaardigheden met het kind.|[Develop 1](develop_1.md)|✅|
|4.11|De verbinding tussen de app en de beer is duidelijk zichtbaar, inclusief correcte overdracht van routines.|[Develop 1](develop_1.md)|✅|